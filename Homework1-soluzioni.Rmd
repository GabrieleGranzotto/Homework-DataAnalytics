...
Abbiamo cercato di indagare sulla presunta differenza tra *maschi* e *femmine* negli *Underweigth* quindi abbiamo disegnato il grafico delle *frequenze relative* di **catbmi** condizionato a **sex**.\
...
Questo grafico inizia a far capire il perché si crea quella differenza così grande.\
Se si vede la differenza dei valori tra *maschi* e *femmine* in un **Barplot** si potrebbe essere indotti a credere che le donne sono più propense ad essere sottopeso.\
...
Ma questo dai dati che abbiamo non può essere evinto, perché abbiamo in possesso troppi pochi dati per quella categoria.\
Se osserviamo la distribuzione dei dati nelle *quattro* categorie ci rendiamo conto di come i dati siano distribuite tra esse.
...
Infine, il test del $\chi^2$ mostra come non si riscontri correlazione tra il *sesso* e il *bmi*.
